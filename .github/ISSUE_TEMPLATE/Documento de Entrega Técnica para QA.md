...
### **5\. Filas/Serviços Assíncronos Envolvidos *(se aplicável)***
...
* Feature Flag **account\_temporarily\_suspended\_payment\_details** deve estar habilitada para visualizar a nova jornada de inadimplência
